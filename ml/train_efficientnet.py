#!/usr/bin/env python3
"""
EfficientNetB0 Transfer Learning for Fruit Grading
"""
...
def fine_tune_model(model, base_model, train_dataset, val_dataset):
    ...
    history = model.fit(
        ...
        callbacks=[
            ...
            keras.callbacks.ModelCheckpoint('ml/models/fruit_grading_efficientnet_finetuned.h5', 
...
def main():
    ...
    print("=" * 60)
    print("🍎 Fruit Grading System - EfficientNetB0 Training")
    print("=" * 60)
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint(
            filepath='ml/models/fruit_grading_efficientnet.keras',
            monitor='val_accuracy',
            save_best_only=True,
            verbose=1
        ),
    ...
    fine_tune_history = fine_tune_model(model, base_model, train_dataset, val_dataset)
    ...
    plt.tight_layout()
    plt.savefig('ml/outputs/training_curves_efficientnet.png', dpi=150)
    plt.show()
    ...
    with open('ml/outputs/efficientnet_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    print("\n" + "=" * 60)
    print("✅ EfficientNetB0 Training Complete!")
    print("=" * 60)
    print(f"\n📁 Model saved to: ml/models/fruit_grading_efficientnet.h5")
